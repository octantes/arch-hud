...
static const char *colorname[] = {
    ...
    /*
     * gradient combos
     * #D8DADE pairs with #0F0C0C
     * #AAABAC pairs with #1A1C1C
     * #3C3C3C middletone #3C3C3C
     * #1A1C1C pairs with #AAABAC
     * #0F0C0C pairs with #D8DADE
     */
	...
	"#AAABAC",
	"#3C3C3C",
	"#D8DADE", /* default foreground colour gray */
	"#0F0C0C", /* default background colour black */
};
