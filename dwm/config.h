...
static const char        *addhtopcmd[]   = GETTABBED("htop");
static const char        *addrmpccmd[]   = GETTABBED("rmpc");
static const char        *addrangcmd[]   = GETTABBED("ranger");
static const char        *addnvimcmd[]   = GETTABBED("nvim");
...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_q,      spawn,          {.v = addnvimcmd}    },
    { MODKEY|ShiftMask,             XK_w,      spawn,          {.v = addsurfcmd}    },
    { MODKEY|ShiftMask,             XK_e,      spawn,          {.v = addhtopcmd}    },
    { MODKEY|ShiftMask,             XK_r,      spawn,          {.v = addrmpccmd}    },
    { MODKEY|ShiftMask,             XK_t,      spawn,          {.v = addrangcmd}    },
